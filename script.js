...
//#if it is a number then its returns false otherwise false.
console.log(`------.isNaN()---------`);
...
//# Min and Max  
//@It do type coersion but it dont parsing
...
//OR
console.log(Math.trunc(Math.random() * 7)); //Generate number between 0 to 6 where 6 is included.
